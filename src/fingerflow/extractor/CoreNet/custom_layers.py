...
def yolov4_head(yolo_neck_outputs):
    ...
    bbox0, object_probability0, class_probabilities0, pred_box0 = get_boxes(
        yolo_neck_outputs[0],
        anchors=anchors[0, :, :],
        grid_size=52, strides=8, xyscale=constants.XY_SCALE[0])
    bbox1, object_probability1, class_probabilities1, pred_box1 = get_boxes(
        yolo_neck_outputs[1],
        anchors=anchors[1, :, :],
        grid_size=26, strides=16, xyscale=constants.XY_SCALE[1])
    bbox2, object_probability2, class_probabilities2, pred_box2 = get_boxes(
        yolo_neck_outputs[2],
        anchors=anchors[2, :, :],
        grid_size=13, strides=32, xyscale=constants.XY_SCALE[2])
